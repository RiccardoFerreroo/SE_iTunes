...
class Model:
    ...
    def load_albums(self, min_duration):
        ...
        self.albums = DAO.get_album_by_min_duration(min_duration) #crea oggetti albums con durata> min_durata
        self.id_map = {a.id: a for a in self.albums} #crea dizionario di dizionari con id_album : titolo album
        #print(self.id_map)
        #print(self.albums)
